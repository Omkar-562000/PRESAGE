      ...
      <section className="relative w-full max-w-6xl overflow-hidden rounded-[40px] border border-white/10 bg-gradient-to-br from-slate-950 via-panel to-shell px-8 py-14 text-center shadow-panel sm:px-12">
        ...
        <div className="relative z-10">
          <div className="mx-auto flex justify-center">
            <img src={bannerImage} alt="Presage banner" className="h-auto w-full max-w-3xl object-contain opacity-95" />
          </div>
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <p className="text-sm text-slate-400">Open the operations workspace to start your live demo.</p>
          </div>
        </div>
      </section>
    </main>
