...
export function IncidentCard({ incident }) {
  return (
    <article className="rounded-[24px] border border-white/8 bg-slate-950/45 p-5">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="min-w-0">
          ...
          <h2 className="mt-2 text-2xl font-semibold text-white">{incident.Title}</h2>
          <p className="mt-4 max-w-3xl text-sm leading-6 text-slate-300">{incident.Evidence}</p>
        </div>
